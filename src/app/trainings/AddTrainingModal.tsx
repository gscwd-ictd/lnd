    ...
    <>
      ...
      <Modal isOpen={isOpen} setIsOpen={setIsOpen} size="lg" isStatic={true} closeFn={() => {}}>
        ...
        <ModalContent>
          ...
          <ModalContent.Body>
            <div className="grid grid-rows-4 grid-cols-3 gap-1 gap-x-3 p-1">
              {/* <div className="row-span-3 bg-cyan-50">01</div> */}
              <div className="col-span-2 bg-cyan-50">
                <div>Course Title:</div>
                <Input />
              </div>
              <div
                className="row-span-3 border-dashed border-2 border-indigo-100 rounded-lg cursor-pointer"
                onClick={() => {
                  // alert("olokloklokloklok");
                }}
              >
              ...
              <div className="col-span-1 bg-cyan-50">
                <div>Duration:</div>
                <Input />
              </div>
              <div className="col-span-1 bg-cyan-50">
