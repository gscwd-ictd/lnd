...
export const DataTableDefaultSelectionToolbar: FunctionComponent = () => {
  ...
  return (
    <div className="flex items-center h-8 mt-2">
      <div className="h-full px-3 py-2 text-center rounded-l bg-indigo-50 flex items-center gap-2">
      ...
      <Tooltip.Provider>
        <Tooltip.Root>
          <Tooltip.Trigger
            className="h-full w-8 bg-indigo-500 flex items-center justify-center rounded-r"
          ...
          <Tooltip.Portal>
            ...
            >
              Clear selection
              <Tooltip.Arrow className="fill-zinc-800" width={12} height={5} />
            </Tooltip.Content>
          </Tooltip.Portal>
        </Tooltip.Root>
      </Tooltip.Provider>
